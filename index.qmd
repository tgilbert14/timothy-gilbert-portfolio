...
<div class="portfolio-home portfolio-home--wild">
  <section class="portfolio-hero portfolio-hero--wild" aria-labelledby="hero-title" data-wild-hero>
    ...
    <div class="portfolio-hero__copy">
      ...
      <p class="portfolio-hero__lede">I’m an ecologist and data scientist who builds R Shiny apps, databases, scrapers, offline field tools, and unnecessarily ambitious browser experiments. I like making complicated things easier to use, and a lot more fun.</p>
  ...
  <div class="build-ticker" aria-label="Tools and subjects I work with">
  ...
  <section class="portfolio-section apps-section" id="apps-and-systems">
    ...
    <div class="app-grid">
      ...
      <article class="app-card reveal" data-reactive-card>
        <div class="app-card__image"><img src="assets/power4-girth-index-cover.png" alt="Power-4 Girth Index cover for 67-program roster intelligence" loading="lazy"><span>02 / SPORTS</span></div>
        <div class="app-card__copy"><h3>Power-4 Girth Index</h3><p>Compare how all 67 ACC, Big Ten, Big 12, and SEC programs build football and basketball rosters: body maps, position profiles, where the high-school talent actually comes from, and whether recruiting strength turns into wins. Yes, the name is intentional.</p><ul class="tech-list"><li>R Shiny</li><li>Live data</li><li>Power-4 matchups</li></ul><div class="case-links"><a href="https://girthindex.desertdatalab.com/" target="_blank" rel="noopener">Open app ↗</a></div></div>
      </article>
      ...
      <article class="app-card reveal" data-reactive-card>
        <div class="app-card__image"><img src="assets/plants-in-movies-botanical-v2.webp" alt="Plants in Movies title artwork with engraved botanical specimens" loading="lazy"><span>04 / BOTANY?</span></div>
        <div class="app-card__copy"><h3>Plants in Movies</h3><p>Explore Arrakis, Middle-earth and Isla Nublar through real plant records. Compare states, look closer with a specimen lens, and save your finds in a field notebook.</p><ul class="tech-list"><li>R Shiny</li><li>USDA data</li><li>Field notebook</li></ul><div class="case-links"><a href="https://019ecc91-3c6c-bee2-f824-0ea23fc60ac6.share.connect.posit.cloud/" target="_blank" rel="noopener">Open app ↗</a></div></div>
      </article>
    </div>
  ...
  <section class="portfolio-section proof-ledger reveal" aria-labelledby="proof-title">
    ...
    <div class="proof-ledger__grid">
      <article data-reactive-card><strong data-count-to="178" data-count-suffix="k+">178k+</strong><span>Capture records traced to individual animals</span></article>
      <article data-reactive-card><strong data-count-to="46">46</strong><span>NEON field sites in one tracker</span></article>
      <article data-reactive-card><strong data-count-to="3">3</strong><span>Movie worlds explored through USDA plant records</span></article>
    </div>
  </section>
  ...
  <section class="portfolio-section capabilities-section">
    <div class="section-heading reveal">
      ...
      <p>I’m happiest on the small, specific problems, like the offline edit that collided with someone else’s, or the trap tag that got reused. Nobody downstream should ever have to know it happened.</p>
    </div>
    <div class="capability-grid">
      ...
      <article class="capability-card reveal" data-reactive-card><span>03</span><h3>Know the field</h3><p>I spent years on field crews running vegetation protocols. I know what they ask of a crew, and what it is like to enter it all on a tablet.</p><small>Vegetation · Wildlife · Spatial data</small></article>
      <article class="capability-card reveal" data-reactive-card><span>04</span><h3>The fun part</h3><p>Maps, charts, motion, and sound. A chart you can poke at (tap a bar, see which families drive the score) beats one you just look at.</p><small>Canvas · Plotly · ggplot2 · Audio</small></article>
    </div>
  </section>
  ...
  <section class="field-story field-story--wild reveal">
    ...
    <div class="field-story__copy">
      <h2>Before the data</h2>
      <p>I was collecting data for NEON before I wrote any code to handle it.</p>
      <p>Small-mammal trapping, vegetation surveys, electrofishing, and soil work. That’s why I build for one thumb in bad lighting, with no signal.</p>
