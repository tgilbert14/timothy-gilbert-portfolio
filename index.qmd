...
```{=html}
<section class="hero">
  <span class="eyebrow">Data Scientist · Ecologist · Founder</span>
  <div class="hero-avatar"><img src="assets/tim_gc.jpg" alt="Tim Gilbert"></div>
  <h1>Turning <span class="accent">messy field data</span> into decisions.</h1>
  ...
  <div class="cta-row">
    ...
    <a class="tg-btn tg-btn-ghost" href="field-notes.qmd">Field notes</a>
    <a class="tg-btn tg-btn-salmon" href="https://desertdatalabs.com/" target="_blank" rel="noopener">Desert Data Labs ↗</a>
  </div>
</section>
```
...
<section class="field-parallax">
  ...
  <div class="fp-overlay">
    ...
    <p>Before the dashboards, there was a lot of dirt — years of rangeland and desert fieldwork around Arizona, plus a wall of the plants I met along the way.</p>
    <a class="tg-btn tg-btn-primary" href="field-notes.qmd">Open the field wall →</a>
  </div>
</section>
...
<div class="sprout-section">
  <div class="sprout-copy">
    <h3>I design &amp; hand-animate things, too</h3>
    <p>Not just dashboards. This is <strong>Sprout</strong> — a brand mark I designed and animated in pure SVG&nbsp;+&nbsp;CSS for Desert Data Labs. No images, no libraries; every vine draws itself and the leaves unfurl. <em>Hover or tap it to watch it grow.</em></p>
  </div>
