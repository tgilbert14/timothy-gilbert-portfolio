  ...
  <section class="portfolio-section apps-section" id="apps-and-systems">
    ...
    <div class="app-grid">
      ...
      <article class="app-card reveal" data-reactive-card>
        ...
        <div class="app-card__copy"><h3>Power-4 Girth Index</h3><p>How all 67 ACC, Big Ten, Big 12, and SEC programs build football and basketball rosters—with live coverage status, body maps, position DNA, and high-school talent geography.</p><ul class="tech-list"><li>R Shiny</li><li>Live data</li><li>Talent maps</li></ul><div class="case-links"><a href="https://girthindex.desertdatalab.com/" target="_blank" rel="noopener">Open app ↗</a></div></div>
      </article>
