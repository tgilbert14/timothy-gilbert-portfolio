...
<section class="field-parallax">
  ...
  <div class="fp-overlay">
    ...
    <p>Before the dashboards, there were years of desert fieldwork around Arizona, plus all the plants I met along the way.</p>
    <a class="tg-btn tg-btn-primary" href="field-notes.qmd">Go to the flora wall →</a>
  </div>
</section>
...
<div class="sprout-section">
  <div class="sprout-copy">
    ...
    <p>Not just dashboards. This is <strong>Sprout</strong> — a brand mark for Desert Data Labs, built in pure SVG&nbsp;+&nbsp;CSS. No images, no libraries; every vine draws itself and the leaves unfurl. <em>Hover or tap it to watch it grow.</em></p>
  </div>
