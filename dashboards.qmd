...
## Power-4 Girth Index — Roster & Recruiting Intelligence

::: explore-text
This app compares how **all 67 programs across the ACC, Big Ten, Big 12, and SEC build football and basketball recruiting classes from 2016–2027.** Start with where the data stands: source and pipeline freshness, program coverage, completed seasons, open classes, and sport-specific snapshots. From there, explore height × weight Body Maps, Position DNA, recruiting and coaching-era trends, and role projections. **Program Reach** maps how far each school recruits, while **Talent Origins** maps the last listed high-school or prep location of captured signees by state, position group, and year. The direct **Matchup** view compares any two programs — for example, Arizona vs. Alabama — while keeping rankings and averages in each program's own-conference context. For football, **Talent vs Results**, **Wins Above Talent**, and the season scoreboard test whether recruiting strength becomes wins. Data comes from 247Sports and CollegeFootballData, with sample sizes, open-cycle flags, and limitations stated in context. A Power-4 relaunch of my earlier *Big-12 Talent Pathways* app.
:::

⭆ [Open the live Power-4 Girth Index](https://girthindex.desertdatalab.com/ "Power-4 Girth Index")
...
[]{#which-states-flora-matches-each-movie-world-best}

## Plants in Movies

::: explore-text
Explore **Arrakis**, **Middle-earth** and **Isla Nublar** through real USDA plant records. Choose states, compare their counts, and open a plant family to see its part in each match.

The new botanical atlas pairs antique-style illustrations with cinematic motion and a movable **specimen lens**. Save up to **12 family comparisons** in your field notebook, then download the counts. Notes last for the current visit, so download them before closing the app.

The percentage view shows each state’s share of the national total for those families. It does not adjust for state size or large plant families. The movie associations are hand-picked, and the generated illustrations are not a guide for identifying plants.
:::

[Open Plants in Movies →](https://019ecc91-3c6c-bee2-f824-0ea23fc60ac6.share.connect.posit.cloud/)

![Plants in Movies title artwork, framed by engraved botanical specimens](assets/plants-in-movies-botanical-v2.webp){.lightboxable}

![The app’s illustrated desert, woodland and fern worlds](assets/plants-in-movies-atlas-v2.webp){.lightboxable}
