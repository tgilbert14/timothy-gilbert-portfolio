...
```{=html}
<div class="neon-suite">
<span class="neon-suite-label">Explore the NEON suite</span>
<span class="neon-suite-btns">
<a class="neon-sib neon-sib--mammal is-current" href="https://tgilbert14.github.io/NEON-Small-Mammal-Tracker-App/" target="_blank" rel="noopener" title="Small mammal box-trapping across NEON sites">🐭 Small Mammals</a>
<a class="neon-sib neon-sib--bird" href="https://tgilbert14.github.io/NEON-Breeding-Birds/" target="_blank" rel="noopener" title="NEON breeding-landbird point counts">🐦 Breeding Birds</a>
<a class="neon-sib neon-sib--beetle" href="https://tgilbert14.github.io/NEON-Ground-Beetle-Tracker/" target="_blank" rel="noopener" title="Carabid (ground beetle) pitfall sampling">🪲 Ground Beetles</a>
<a class="neon-sib neon-sib--plantdiv" href="https://tgilbert14.github.io/NEON-Plant-Diversity/" target="_blank" rel="noopener" title="Plant presence & percent cover">🌿 Plant Diversity</a>
<a class="neon-sib neon-sib--pheno" href="https://tgilbert14.github.io/NEON-Plant-Phenology-Explorer/" target="_blank" rel="noopener" title="Plant phenology / phenophase observations">🌸 Plant Phenology</a>
<a class="neon-sib neon-sib--veg" href="https://tgilbert14.github.io/NEON-Vegetation-Structure-Explorer/" target="_blank" rel="noopener" title="Woody vegetation structure">🌲 Veg Structure</a>
<a class="neon-sib neon-sib--water" href="https://tgilbert14.github.io/NEON-WaterChemistry-Analyte-Viewer-App/" target="_blank" rel="noopener" title="Surface-water chemistry analytes">💧 Water Chemistry</a>
</span>
</div>
<a class="neon-cascade" href="https://tgilbert14.github.io/NEON-Driver-Cascade/" target="_blank" rel="noopener" title="Cross-product synthesis across the whole NEON explorer suite">
<span class="neon-cascade-bolt">⚡</span>
<span class="neon-cascade-copy"><span class="neon-cascade-title">The NEON Driver Cascade</span><span class="neon-cascade-sub">the capstone that ties all seven explorers into one story →</span></span>
</a>
```
...
Seven NEON explorers, all built the same way — open data, pre-bundled so they load instantly, with the Driver Cascade weaving them together. Use the buttons above to open any of them, or dig into two here:

<details class="neon-more">
<summary>More NEON apps · Ground Beetle Tracker + Water Chemistry Viewer</summary>

[🪲 NEON Ground Beetle Tracker]{.neon-more-title}

::: explore-text
This Shiny app turns NEON pitfall-trap sampling into a tour of **ground beetles (Carabidae) as bioindicators across 46 NEON terrestrial sites**. Rank a site's species by effort-adjusted abundance (catch per 100 trap-nights), trace diversity with **Hill numbers**, **Hurlbert rarefaction**, and species-accumulation curves, read each species' monthly **activity-density**, and follow inter-annual catch-per-effort **trends** with an OLS fit that states the direction and rate with a p-value. A **biogeography** tab adds a national richness map, species range maps, a Bray-Curtis **PCoA** ordination, and Dufrêne-Legendre indicator-species analysis. Counts are effort-normalized, richness excludes genus- and family-only records, and all 46 sites are precomputed into a bundled dataset so it loads instantly.
:::

⭆ [Open the project](https://tgilbert14.github.io/NEON-Ground-Beetle-Tracker/ "NEON Ground Beetle Tracker")

![](assets/beetle-community.png){.lightboxable} ![](assets/beetle-trends.png){.lightboxable}

[💧 Water Chemistry Analyte Viewer]{.neon-more-title}
