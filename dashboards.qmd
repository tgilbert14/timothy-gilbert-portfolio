...
::: explore-text
This app compares how **all 67 ACC, Big Ten, Big 12, and SEC programs build football and basketball rosters from 2016 through the current recruiting cycle.** Its redesigned dashboard establishes the live picture first: source and pipeline freshness, program coverage, completed seasons, open classes, and sport-specific snapshots. From there, explore height × weight Body Maps, Position DNA, team reach, recruiting and coaching-era trends, and role projections; **Talent Origins** maps the last listed high-school or prep location of captured signees by state, position group, and year. Data comes from 247Sports and CollegeFootballData, with sample sizes, open-cycle flags, and limitations stated in context. A Power-4 relaunch of my earlier *Big-12 Talent Pathways* app.
:::
