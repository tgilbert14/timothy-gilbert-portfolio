...
::: explore-text
This app compares how **all 67 programs across the ACC, Big Ten, Big 12, and SEC build football and basketball recruiting classes from 2016–2027.** Its dashboard establishes the live picture first: source and pipeline freshness, program coverage, completed seasons, open classes, and sport-specific snapshots. From there, explore height × weight Body Maps, Position DNA, recruiting and coaching-era trends, and role projections. **Program Reach** maps how far each school recruits, while **Talent Origins** reveals where captured high-school and prep talent comes from by state, position group, and year. The direct **Matchup** view can compare any two programs — for example, Arizona vs. Alabama — while keeping rankings and averages in each program's own-conference context. For football, **Talent vs Results**, **Wins Above Talent**, and the season scoreboard test whether recruiting strength becomes wins. Data comes from 247Sports and CollegeFootballData, with sample sizes, open-cycle flags, and limitations stated in context.
:::
