...
Scripts originally built to scrape recruiting data from multiple sports sites (e.g., 247Sports, On3) and visualize Big 12 football and basketball class rankings over time. That work now feeds the live **Power-4 Girth Index**: 67 programs across the ACC, Big Ten, Big 12, and SEC, with football and basketball recruiting coverage from 2016–2027. Its direct **Matchup** view makes cross-conference comparisons such as Arizona vs. Alabama clear while preserving each program's own-conference ranking and average context.
